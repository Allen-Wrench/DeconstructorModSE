...
namespace Dematerializer
{
	...
	public class DematerializerLog : MySessionComponentBase
	{
		private static DematerializerLog instance;
		...
		{
			private DematerializerLog sessionComp;
			...
			public void Init(DematerializerLog sessionComp)
			{
				if (writer != null)
				...
				writer = MyAPIGateway.Utilities.WriteFileInLocalStorage(FILE, typeof(DematerializerLog));
